...
const queries = {
    ...
    patch: (url: string, body: {}) => axios.patch(url, body).then((response: AxiosResponse) => response.data),
...
const Errors = {
    ...
    getValidationError: () => queries.get("/error/valid-error")
...
const Order = {
    ...
    creteaOrder: (formData: any) => queries.post("order/createorder",formData)
}
const requests = {
